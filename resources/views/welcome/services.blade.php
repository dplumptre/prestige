...
@section('content')
			...
			<!-- ================ -->
			<div class="banner">
				<div class="fixed-image section light-translucent-bg" style="background-image:url('images/page-about-banner-2.jpg');">
					<div class="container">
					<div class="space-top"></div>
					<h1>Services</h1>
					<div class="separator-2"></div>
					<p class="lead">We are all about custom and service. <br class="hidden-xs hidden-sm">We specialize in one thing "...prestigious designs" using a fresh & sophisticated approach to designing contemporary environments. <br class="hidden-xs hidden-sm"> With every project they transform each individual's lifestyle into timeless elegance & luxurious interiors while bringing their client's vision to life.</p>
					</div>
				</div>
			</div>
			<!-- banner end -->
						...
						<div class="main col-md-12">
							...
							<div class="row">
								<div class="col-md-8">
									...
									<h3>Here is our process flow</h3>
									<p>We will work with you to determine a budget that accomplishes your overall project goals </p>
									<ul class="list-icons">
										<li class="object-non-visible" data-animation-effect="fadeInUpSmall" data-effect-delay="100"><i class="icon-check"></i> We listen to your design dreams and create a customized, functional design just for YOU. </li>
